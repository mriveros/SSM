...
public class DialogImagenes2 extends DialogFragment {

    private ArrayList<Capturas> imagenes;

    public DialogImagenes2(ArrayList<Capturas> imagenes) {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        for (Capturas capturas : imagenes) {
            strings.add(capturas.getPath());
        }
        final GaleriaAdapter galeria = new GaleriaAdapter(strings, getActivity().getApplicationContext());
